python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --wandb_run_name "roberta-base-wic"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --mask --wandb_run_name "roberta-base-wic-mask"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --target --wandb_run_name "roberta-base-wic-target"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --supersense --wandb_run_name "roberta-base-wic-supersense"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --mask --target --wandb_run_name "roberta-base-wic-mask-target"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --mask --supersense --wandb_run_name "roberta-base-wic-mask-supersense"
python bert-weak-supervision.py --model FacebookAI/roberta-base --dataset wic --target --supersense --wandb_run_name "roberta-base-wic-target-supersense"
